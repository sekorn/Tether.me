...
func makeBubble() -> (incoming: UIImage, outgoing: UIImage) {
    ...
    let incoming = coloredImage(flippedImage, red: 229/255, green: 122/255, blue: 122/255, alpha: 1).resizableImageWithCapInsets(insetsIncoming)
